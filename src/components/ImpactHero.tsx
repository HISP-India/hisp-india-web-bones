...
const stats: Stat[] = [
  ...
  },
  {
    icon: Database,
    value: "30+",
    label: "DHIS2 & OpenMRS Deployments",
    className: "bg-card border border-border",
    iconClass: "bg-primary/10 text-primary",
  },
  {
    ...
    sublabel: "Strengthening public health since 2008",
