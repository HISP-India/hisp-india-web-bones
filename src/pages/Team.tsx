...
import jyotsnaImage from "@/assets/jyotsna-sahay.png";
import vinayImage from "@/assets/vinay-modgil.png";
...
const departments = [
  ...
  },
  {
    ...
    subtitle: "Development and Infrastructure",
    members: [
      {
        id: "20",
          ...
          <section key={deptIndex} className={deptIndex % 2 === 0 ? "py-16 md:py-20" : "py-16 md:py-20 bg-muted"}>
            <div className="container">
              <div className="mb-8 text-center">
                <h2 className="font-heading text-3xl font-bold">{department.name}</h2>
                {department.subtitle && (
                  <p className="text-muted-foreground text-lg mt-2 font-medium tracking-wide">
                    — {department.subtitle} —
                  </p>
                )}
              </div>
